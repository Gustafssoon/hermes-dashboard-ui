/* ============================================================
   Tingzel Pantheon — Icon component
   ------------------------------------------------------------
   Path data is from Lucide (https://lucide.dev), MIT licensed.
   Inlined for offline reliability. Stroke-only, currentColor,
   stroke-width 1.75 to match the calm/engineered tone.
   ============================================================ */
...
function Icon({ name, size = 18, stroke = 1.75, className = "", style = {} }) {
  const d = PANTHEON_ICONS[name] || PANTHEON_ICONS["circle-dot"];
  return (
    <svg
      className={className}
      width={size}
